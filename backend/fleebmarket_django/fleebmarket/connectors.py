...
class RedditClient:
    ...
    def __init__(self):
        if RedditClient._instance is None:
            RedditClient._instance = praw.Reddit(
                **settings.REDDIT_BOT_CREDS
            )
...
class DiscordClient:
    ...
    def send_message(self, user_id, message):
        ...
        resp = requests.post(f"https://discord.com/api/channels/{channel_id}/messages", json={"content": message}, headers=self.headers)
