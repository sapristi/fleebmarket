...
class FirstSurveyForm(ModelForm):
    class Meta:
        ...
        labels = {
            ...
            "most_used_service": (
                "Which second hand keyboard market service do you use ?"
            ),
            "service_interest": (
                "Would you be interested in using a dedicated service ?"
            ),
            "essential_features": (
                "What are the essential features of the service you actually use ?"
            ),
            "missed_features": (
                "What features do you miss the most in the service you use ?"
            ),
            "would_pay": (
                "Would you be ready to pay a small monthly fee (between 1 and 2€) for some advanced features  ?"
            ),
